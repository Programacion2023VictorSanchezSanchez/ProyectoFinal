...
CREATE TABLE IF NOT EXISTS `mydb`.`Prestamo` (
  ...
  PRIMARY KEY (`idPrestamo`, `disponibles`, `ISBN`, `idSocio`, `fecha_inicio`),
  INDEX `fk_EjemplaresDisponibles_has_Socio_Socio1_idx` (`idSocio` ASC),
  INDEX `fk_EjemplaresDisponibles_has_Socio_EjemplaresDisponibles1_idx` (`disponibles` ASC, `ISBN` ASC),
  CONSTRAINT `fk_EjemplaresDisponibles_has_Socio_EjemplaresDisponibles1`
    FOREIGN KEY (`disponibles` , `ISBN`)
